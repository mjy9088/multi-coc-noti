...
type Upgrade = { id: string; accountId: string; name: string; type: string; level: number; nextLevel: number; finishAt: string; status: string; source: "export"; notificationOffsets: number[]; resourcePreparationOverrideMinutes: number | null };
