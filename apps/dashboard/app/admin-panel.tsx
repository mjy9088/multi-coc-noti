...
export default function AdminPanel({ locale, apiBase, onChanged }: { locale: Locale; apiBase: string; onChanged: () => void }) {
  const ko = locale === "ko";
