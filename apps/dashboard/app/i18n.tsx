...
const messages = {
  "ko-KR": {
    dashboard: "대시보드", history: "히스토리", settings: "알림 설정", demo: "데모 데이터", synced: "마지막 동기화", exampleIncluded: "예제 데이터 포함", example: "예제", eyebrow: "VILLAGE OVERVIEW", title: "오늘의 마을 현황", subtitle: "모든 계정의 빌더와 연구 진행 상황을 한곳에서 확인하세요.", accounts: "운영 계정", builders: "대기 빌더", earliest: "가장 빠른 완료", none: "없음", all: "전체 계정", normal: "API 동기화", manual: "수동 데이터", delayed: "API 지연", profileApi: "프로필 API", resourceApi: "자원", syncedState: "정상", delayedState: "지연", disabledState: "미설정", manualState: "수동", builder: "빌더", inProgress: "진행 중", updated: "업데이트", queue: "완료 예정 업그레이드", soonest: "빠른 순서", soon: "곧 완료", remaining: "남은 시간", underMinute: "1분 미만", empty: "진행 중인 업그레이드가 없습니다.", dataStatus: "JSONL 수집 상태", awaiting: "연결 대기 중", bark: "Bark 알림", enabled: "활성", building: "건물", hero: "영웅", pet: "펫", research: "연구소", level: "레벨", gold: "골드", elixir: "엘릭서", dark: "다크 엘릭서", search: "계정 이름·태그 검색", statusAll: "모든 상태", freeOnly: "대기 빌더 있음", delayedOnly: "API 동기화 지연", noMatches: "조건에 맞는 계정이 없습니다.", resourceUnknown: "자원 정보 없음", resourceHint: "공식 Clash API와 게임 export에는 현재 보유 자원이 없습니다. 계정 설정에서 자원 API를 연결하면 주기적으로 표시됩니다.", farmEmpty: "자원 데이터를 제공한 마을이 없어 우선순위를 계산하지 않았습니다.", farmTitle: "파밍 우선순위", farmSubtitle: "자원 부족률과 대기 빌더를 기준으로 지금 돌볼 마을을 정렬했습니다.", heuristic: "계획 중인 업그레이드 비용이 연결되기 전까지 골드·엘릭서 부족률 75%, 대기 빌더 비율 25%로 계산합니다.", farmNow: "지금 파밍", farmNext: "다음 순서", farmSteady: "여유", goldLow: "골드 우선", elixirLow: "엘릭서 우선", builderReady: "빌더 대기", priority: "우선도", displayOptions: "표시 옵션", inferGoblinResearcher: "고블린 연구원 여유 슬롯 추정", inferGoblinBuilder: "고블린 장인 여유 슬롯 추정",
    dashboardSubtitle: "모든 계정의 빌더와 연구 진행 상황을 한곳에서 확인하세요.",
  ...
  "en-US": {
    dashboard: "Dashboard", history: "History", settings: "Alerts", demo: "Demo data", synced: "Last sync", exampleIncluded: "Includes example data", example: "Example", eyebrow: "VILLAGE OVERVIEW", title: "Village status today", subtitle: "Track builders, research, and resources across every account.", accounts: "Accounts", builders: "Free builders", earliest: "Next completion", none: "None", all: "All accounts", normal: "API synced", manual: "Manual data", delayed: "API delayed", profileApi: "Profile API", resourceApi: "Resources", syncedState: "live", delayedState: "delayed", disabledState: "not set", manualState: "manual", builder: "Builders", inProgress: "In progress", updated: "Updated", queue: "Upcoming completions", soonest: "Soonest first", soon: "Finishing soon", remaining: "Time left", underMinute: "Under 1m", empty: "No upgrades are currently running.", dataStatus: "JSONL collector", awaiting: "Awaiting connection", bark: "Bark alerts", enabled: "On", building: "Building", hero: "Hero", pet: "Pet", research: "Laboratory", level: "Level", gold: "Gold", elixir: "Elixir", dark: "Dark Elixir", search: "Search name or tag", statusAll: "All statuses", freeOnly: "Builder available", delayedOnly: "API sync delayed", noMatches: "No accounts match these filters.", resourceUnknown: "Resources unavailable", resourceHint: "The official Clash API and game exports omit current resources. Connect a resource API in account settings to sync them periodically.", farmEmpty: "Farming priority is unavailable because no village has resource data.", farmTitle: "Farming priority", farmSubtitle: "Villages are ranked by resource shortage and available builders.", heuristic: "Until planned upgrade costs are connected, the score uses 75% gold/elixir shortage and 25% free-builder ratio.", farmNow: "Farm now", farmNext: "Up next", farmSteady: "Steady", goldLow: "Prioritize gold", elixirLow: "Prioritize elixir", builderReady: "Builder ready", priority: "Priority", displayOptions: "Display options", inferGoblinResearcher: "Infer Goblin Researcher availability", inferGoblinBuilder: "Infer Goblin Builder availability",
    dashboardSubtitle: "Track builders and research across every account.",
