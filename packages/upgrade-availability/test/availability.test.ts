...
test("observes Goblin helpers from concurrent work", () => {
...
test("offers a second research slot when one account proves the event is active", () => {
...
test("offers a Goblin Builder only after all eligible regular builders are busy", () => {
...
test("respects disabled inference options", () => {
